...
```
cd ~
go get github.com/scroot/go-ts-segmenter
```
3. Go the the source code dir `
```
cd go/src/github.com/scroot/go-ts-segmenter
```
...
```
Note: To serve the LHLS data generated by this application you need to use [webserver-chunked-growingfiles](https://github.com/scroot/webserver-chunked-growingfiles). The stream will play in any HLS compatible player, but if you really want t see ultra low latency you will need to use this player (TODO)
